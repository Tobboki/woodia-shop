...
export const selectContentVariants = cva('z-9999 min-w-full overflow-y-auto rounded-md border border-black/25 bg-surface-light font-placeholder shadow-lg animate-in fade-in-0 zoom-in-95');
