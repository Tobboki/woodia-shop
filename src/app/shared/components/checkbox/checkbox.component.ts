    ...
    >
      <main class="flex relative">
        ...
        <z-icon
          zType="check"
          [class]="
            'absolute flex items-center justify-center text-primary-foreground text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none transition-opacity ' +
