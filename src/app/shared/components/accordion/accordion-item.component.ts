...
import type { ZardAccordionComponent } from 'src/app/shared/components/accordion/accordion.component';
import {
  accordionContentVariants,
  accordionItemVariants,
  accordionTriggerVariants,
} from 'src/app/shared/components/accordion/accordion.variants';
  ...
  template: `
    ...
    >
      <div class="flex flex-nowrap items-center gap-2">
        <z-icon [zType]="zTitleIcon()" zSize="lg"/>
        {{ zTitle() }}
      </div>
      <z-icon
        zType="chevron-down"
...
export class ZardAccordionItemComponent {
  ...
  readonly zTitleIcon = input<ZardIcon>('circle');
