      ...
      @if (store.activeMainTab() === 'model') {
        <div class="space-y-6">
          <div [class.hidden]="store.activeControlTab() !== 'color'" class="lg:block space-y-3">
            <h5 class="font-label text-foreground/60 hidden lg:block">{{ t('sharedLib.designConfigurator.controls.color') }}</h5>
            <z-form-field>
        ...
        <div [class.hidden]="!['width', 'height', 'depth', 'overhang'].includes(store.activeControlTab())"
          ...
          <div [class.hidden]="store.activeControlTab() !== 'overhang'" class="lg:block">
            <z-form-field>
        ...
        <div [class.hidden]="store.activeControlTab() !== 'legroom'" class="lg:block space-y-4">
          <z-form-field>
