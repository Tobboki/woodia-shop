...
export const selectTriggerVariants = cva(
  mergeClasses(
    'flex w-full font-medium items-center justify-between gap-2 rounded-md border border-input bg-background',
    ...
    'dark:hover:bg-input/50 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40',
